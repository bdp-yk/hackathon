  ...
  <q-page padding>
    <div class="q-pa-md">
      <q-stepper v-model="step" ref="stepper" color="primary" animated>
        ...
        >
          ...
          >
            <div class="dropzone-custom-content">
              <q-icon name="cloud_upload" size="12vw"></q-icon>
        ...
        >
          <div>
            <div class="text-h6 q-mx-lg q-pb-none">
              Would you like to describe it?
            </div>
            <div class="text-caption text-italic q-mx-lg q-pt-none">
              Some prefers land, some enjoy beaches, what about you dear user?
            </div>
            ...
            <br />
            <div class="text-h6 q-mx-lg q-pb-none">
              When would you like to start this adventure?
            </div>
            <div class="text-caption text-italic q-mx-lg q-pt-none">
            ...
            <div class="row q-pa-md q-ma-lg justify-center q-col-gutter-x-lg">
              <q-input label="From" class="col-4" filled v-model="startDate">
              ...
              <q-input label="To" class="col-4" filled v-model="endDate">
                <template v-slot:prepend>
                  <q-icon name="event" class="cursor-pointer">
                    <q-popup-proxy
                      transition-show="scale"
        ...
        >
          <q-inner-loading :showing="loading">
            <img src="../assets/cuteloader.gif" />
          </q-inner-loading>
          <div class="text-h6 q-mx-lg q-pb-none" v-if="!loading">
          ...
          <carousel-3d
            class="full-width row wrap justify-center items-center content-stretch"
        ...
        <q-step :name="4" title="Get some Credit" icon="money">
          <div class="text-h6 q-mx-lg q-pb-none">
            Enhance your adventure with the Libra Experience?
          </div>
          <div class="text-caption text-italic q-mx-lg q-pt-none">
          ...
          <div class="row q-col-gutter-lg q-pa-lg">
            ...
            <img class="col-6" src="../assets/hand_transfer.png" />
          </div>
        </q-step>
